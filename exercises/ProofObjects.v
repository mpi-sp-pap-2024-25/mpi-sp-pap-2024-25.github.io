...
(** **** Exercise: 2 stars, standard (conj_fact)
    ...
    Construct a proof object for the following proposition.  The goal
    of these exercises is to teach you how to write proof objects by
    hand, which is also helpful for the exam.  So submitting ugly
    proof objects produced by tactics such as destruct will definitely
    not earn you full points for such exercises. *)
